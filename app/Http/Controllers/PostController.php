...
class PostController extends Controller
{
    ...
    public function index(Request $request, Builder $htmlBuilder)
    {
       if ($request->ajax()) {
            ...
            ->addColumn('action', function($posts){
                ...
                'show_url' => route('posts.show', $posts->id)]);
            })
    ...
    public function store(Request $request)
    {
       ...
       $posts = Post::create(['title' => $request->title, 'seotitle' => str_slug($request->title, '-'), 'author' => $request->author, 'headline' => $request->headline, 'active' => $request->active, 'image' => $request->fupload, 'content' => $request->content, 'status' => $request->status]);
