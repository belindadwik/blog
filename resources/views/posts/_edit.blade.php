<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<img src="{{url('thumbs')}}/{{$posts->image}}" class="img-responsive img-thumbnail" alt="{{$posts->image}}">
			<div class="input-group">
				{!! Form::text('image', null, ['class'=>'form-control']) !!}
				<span class="input-group-btn">
					<a data-fancybox data-type="iframe" href="{{ asset('js/filemanager/dialog.php?type=1&field_id=image&relative_url=1') }}" class="btn btn-success" type="button">Ganti Gambar</a>
				</span>
			</div>
		</div>
	</div>
